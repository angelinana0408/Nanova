...
namespace MyFirstDAQApp
{
    public partial class Form1 : Form
    {
        ...
        #endregion
        /*ports defination*/
        private string P_pump = "dev1/port1/line2";//pump, P12
        private string P_v1 = "dev1/port0/line0";//valve1, P00
        private string P_preH1 = "dev1/port1/line3";//precon high1, P13
        private string P_preOn1 = "dev1/port0/line1";//precon On1, P01
        private string P_column = "dev1/port0/line4";//column
        /*packed methods*/
...
/*******************************************************************************************************************/
        ...
        private void timerMenu_Tick(object sender, EventArgs e)//flow control loop
        {
            ...
            if (System.DateTime.Now.Subtract(startTime).TotalMilliseconds < (pumpingT * 1000))
            {
                ...
                digitalOutHigh(1); valveIndicator1.BackColor = Color.Green;
                digitalOutLow(2); preconOnIndicator1.BackColor = Color.Gray;
                digitalOutLow(3); preconHighIndicator1.BackColor = Color.Gray;
            ...
            else if (System.DateTime.Now.Subtract(startTime).TotalMilliseconds < ((pumpingT + waitingT) * 1000))
            {
                ...
                digitalOutLow(1); valveIndicator1.BackColor = Color.Gray;
                digitalOutLow(2); preconOnIndicator1.BackColor = Color.Gray;
                digitalOutLow(3); preconHighIndicator1.BackColor = Color.Gray;
            ...
            else if (System.DateTime.Now.Subtract(startTime).TotalMilliseconds < ((pumpingT + waitingT + preconHighT) * 1000))
            {
                digitalOutLow(0); pumpIndicator.BackColor = Color.Gray;
                digitalOutLow(1); valveIndicator1.BackColor = Color.Gray;
                digitalOutHigh(2); preconOnIndicator1.BackColor = Color.Green;
                digitalOutHigh(3); preconHighIndicator1.BackColor = Color.Green;
            }
            else if (System.DateTime.Now.Subtract(startTime).TotalMilliseconds < ((pumpingT + waitingT + preconHighT + preconLowT) * 1000))
            {
                ...
                digitalOutLow(1); valveIndicator1.BackColor = Color.Gray;
                digitalOutHigh(2); preconOnIndicator1.BackColor = Color.Green;
                pwmout3(50); preconHighIndicator1.BackColor = Color.Gray;
            }
            else
            {
                digitalOutLow(0); pumpIndicator.BackColor = Color.Gray;//clear all expected
                digitalOutLow(1); valveIndicator1.BackColor = Color.Gray;
                digitalOutLow(2); preconOnIndicator1.BackColor = Color.Gray;
                digitalOutLow(3); preconHighIndicator1.BackColor = Color.Gray;
                return;
